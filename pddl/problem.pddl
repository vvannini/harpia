...
(:init
    ...
    (= (distance region_1 region_5) 697.435)
    (= (distance region_1 region_6) 943.387)
    ...
    (= (distance region_2 region_5) 633.041)
    (= (distance region_2 region_6) 788.35)
    ...
    (= (distance region_3 region_5) 535.169)
    (= (distance region_3 region_6) 550.828)
    ...
    (= (distance region_4 region_5) 388.014)
    (= (distance region_4 region_6) 407.678)
    (= (distance region_4 base_1) 353.116)
    (= (distance region_4 base_2) 578.142)
    (= (distance region_4 base_3) 452.557)
    (= (distance region_5 region_1) 697.435)
    (= (distance region_5 region_2) 633.041)
    (= (distance region_5 region_3) 535.169)
    (= (distance region_5 region_4) 388.014)
    (= (distance region_5 region_6) 296.67)
    (= (distance region_5 base_1) 518.356)
    (= (distance region_5 base_2) 361.668)
    (= (distance region_5 base_3) 403.005)
    (= (distance region_6 region_1) 943.387)
    (= (distance region_6 region_2) 788.35)
    (= (distance region_6 region_3) 550.828)
    (= (distance region_6 region_4) 407.678)
    (= (distance region_6 region_5) 296.67)
    (= (distance region_6 base_1) 696.244)
    (= (distance region_6 base_2) 656.957)
    (= (distance region_6 base_3) 106.96)
    ...
    (= (distance base_1 region_5) 518.356)
    (= (distance base_1 region_6) 696.244)
    ...
    (= (distance base_2 region_5) 361.668)
    (= (distance base_2 region_6) 656.957)
    ...
    (= (distance base_3 region_5) 403.005)
    (= (distance base_3 region_6) 106.96)
