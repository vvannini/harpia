...
def checkValues(uav_var, statistics, module1, module2):
    ...
    n_roll  = (uav_var['roll'] -statistics['Avg'][0])/statistics['std'][0] 
    n_pitch = (uav_var['pitch']-statistics['Avg'][1])/statistics['std'][1] 
    n_yaw   = (uav_var['yaw']  -statistics['Avg'][2])/statistics['std'][2] 
    ...
    # inputArray = np.array([[uav_var['roll'],uav_var['pitch'],uav_var['yaw']]])
    inputArray = np.array([[n_roll,n_pitch,n_yaw]])
